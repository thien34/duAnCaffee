...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("7", "Thương Hiệu", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("8", "Thành Phần", Model_Menu.MenuType.MENU));
    ...
    protected void paintChildren(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#609966"), 0, getHeight(), Color.decode("#91C788"));
        g2.setPaint(g);
